...
// Mon May 23 16:10:33 2016 by ROOT version 6.02/05
// from TTree EventTree/Event data
// found on file: root://cmsxrootd.fnal.gov//store/group/phys_smp/ggNtuples/13TeV/data/V07_04_16_03/job_DoubleEG_Run2015C_Oct05_miniAOD.root
//////////////////////////////////////////////////////////

#ifndef MyNtupleMakerQQQ_h
#define MyNtupleMakerQQQ_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<bool>    *tauByMVA5VLooseElectronRejection;
   ...
   vector<bool>    *taubyLoosePileupWeightedIsolation3Hits;
   vector<bool>    *taubyMediumPileupWeightedIsolation3Hits;
   vector<bool>    *taubyTightPileupWeightedIsolation3Hits;
   vector<bool>    *taubyPhotonPtSumOutsideSignalCone;
   vector<bool>    *taubyPileupWeightedIsolationRaw3Hits;
   ...
   TBranch        *b_tauByMVA5VLooseElectronRejection;   //!
   ...
   TBranch        *b_taubyLoosePileupWeightedIsolation3Hits;   //!
   TBranch        *b_taubyMediumPileupWeightedIsolation3Hits;   //!
   TBranch        *b_taubyTightPileupWeightedIsolation3Hits;   //!
   TBranch        *b_taubyPhotonPtSumOutsideSignalCone;   //!
   TBranch        *b_taubyPileupWeightedIsolationRaw3Hits;   //!
   ...
   MyNtupleMakerQQQ(TTree *tree=0);
   virtual ~MyNtupleMakerQQQ();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(TString outfile, Long64_t Start, Long64_t Stop);
...
#ifdef MyNtupleMakerQQQ_cxx
MyNtupleMakerQQQ::MyNtupleMakerQQQ(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/group/phys_smp/ggNtuples/13TeV/data/V07_04_16_03/job_DoubleEG_Run2015C_Oct05_miniAOD.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/group/phys_smp/ggNtuples/13TeV/data/V07_04_16_03/job_DoubleEG_Run2015C_Oct05_miniAOD.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmsxrootd.fnal.gov//store/group/phys_smp/ggNtuples/13TeV/data/V07_04_16_03/job_DoubleEG_Run2015C_Oct05_miniAOD.root:/ggNtuplizer");
...
MyNtupleMakerQQQ::~MyNtupleMakerQQQ()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t MyNtupleMakerQQQ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t MyNtupleMakerQQQ::LoadTree(Long64_t entry)
{
...
void MyNtupleMakerQQQ::Init(TTree *tree)
{
   ...
   tauByMVA5VLooseElectronRejection = 0;
   ...
   taubyLoosePileupWeightedIsolation3Hits = 0;
   taubyMediumPileupWeightedIsolation3Hits = 0;
   taubyTightPileupWeightedIsolation3Hits = 0;
   taubyPhotonPtSumOutsideSignalCone = 0;
   taubyPileupWeightedIsolationRaw3Hits = 0;
   ...
   fChain->SetBranchAddress("tauByMVA5VLooseElectronRejection", &tauByMVA5VLooseElectronRejection, &b_tauByMVA5VLooseElectronRejection);
   ...
   fChain->SetBranchAddress("taubyLoosePileupWeightedIsolation3Hits", &taubyLoosePileupWeightedIsolation3Hits, &b_taubyLoosePileupWeightedIsolation3Hits);
   fChain->SetBranchAddress("taubyMediumPileupWeightedIsolation3Hits", &taubyMediumPileupWeightedIsolation3Hits, &b_taubyMediumPileupWeightedIsolation3Hits);
   fChain->SetBranchAddress("taubyTightPileupWeightedIsolation3Hits", &taubyTightPileupWeightedIsolation3Hits, &b_taubyTightPileupWeightedIsolation3Hits);
   fChain->SetBranchAddress("taubyPhotonPtSumOutsideSignalCone", &taubyPhotonPtSumOutsideSignalCone, &b_taubyPhotonPtSumOutsideSignalCone);
   fChain->SetBranchAddress("taubyPileupWeightedIsolationRaw3Hits", &taubyPileupWeightedIsolationRaw3Hits, &b_taubyPileupWeightedIsolationRaw3Hits);
...
Bool_t MyNtupleMakerQQQ::Notify()
{
...
void MyNtupleMakerQQQ::Show(Long64_t entry)
{
...
Int_t MyNtupleMakerQQQ::Cut(Long64_t entry)
{
...
#endif // #ifdef MyNtupleMakerQQQ_cxx
