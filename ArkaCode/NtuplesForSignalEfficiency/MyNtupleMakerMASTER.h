...
// Fri Feb 19 20:47:31 2016 by ROOT version 6.02/05
// from TTree EventTree/Event data
// found on file: root://cmsxrootd.fnal.gov//store/user/areinsvo/T5gg_V07-04-14_sorted/T5gg_mGlu_1000_mNeu_800.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   virtual void     Loop(TString outfile="", double WEIGHT=1.0);
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("root://cmsxrootd.fnal.gov//store/user/areinsvo/T5gg_V07-04-14_sorted/T5gg_mGlu_1000_mNeu_800.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("root://cmsxrootd.fnal.gov//store/user/areinsvo/T5gg_V07-04-14_sorted/T5gg_mGlu_1000_mNeu_800.root");
      }
      TDirectory * dir = (TDirectory*)f->Get("root://cmsxrootd.fnal.gov//store/user/areinsvo/T5gg_V07-04-14_sorted/T5gg_mGlu_1000_mNeu_800.root:/ggNtuplizer");
...
void MyNtupleMakerQQQ::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("mcGMomMass", &mcGMomMass, &b_mcGMomMass);
