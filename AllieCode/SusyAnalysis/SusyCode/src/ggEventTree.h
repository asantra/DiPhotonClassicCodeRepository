...
ggEventTree::ggEventTree(TTree* inputChain){
  ...
  eleFiredTrgs_ = new vector<int>;
  chain->SetBranchStatus("eleFiredTrgs",1);
  chain->SetBranchAddress("eleFiredTrgs", &eleFiredTrgs_);
...
chain->SetBranchAddress("phoPFPhoIso", &phoPFPhoIso_);
 ...
 // phoFiredTrgs_ = new vector<int>;
 //chain->SetBranchStatus("phoFiredTrgs",1);
 //chain->SetBranchAddress("phoFiredTrgs", &phoFiredTrgs_);
