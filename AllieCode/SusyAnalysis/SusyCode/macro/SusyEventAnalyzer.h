...
//    std::vector<float> GetMetAndInvMassProbs(float invmass, float met, TH1F* SMmet, TH1F* SMinvmass, TH1F* BGmet, TH1F* BGinvmass, TH1F* NewHiggsMet);
    ...
    void CategorizeEvents(int pho1, int pho2, int pho3, float Rho, bool &gogg, bool &goee, bool &goeg, bool &goff, bool &gogammafake, bool &gogf, bool &gofg, bool &use13, bool &use23);
